...
namespace TownOfUs
{
    public static class CustomGameOptions
    {
        ...
        public static int EraserOn => (int) Generate.EraserOn.Get();
        ...
        public static bool SheriffKeepsGameAlive => Generate.SheriffKeepsGameAlive.Get();
        ...
        public static bool SnitchTargetsCrewmate => Generate.SnitchTargetsCrew.Get();
        ...
        public static float EraseCd => Generate.EraseCooldown.Get();
        public static float ErasePenaltyCd => Generate.EraserCrewPenalty.Get();
